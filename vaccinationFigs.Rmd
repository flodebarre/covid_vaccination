...
plotDyn <- function(icat, geog = "France"){
  ...
  polygon(as.Date(c(newdat$jour, rev(newdat$jour), newdat[1, "jour"])), 
          c(newdat$couv_dose1, rev(newdat$couv_complet), newdat[1, "couv_dose1"]), border = gray(0, 0), col = adjustcolor(lighten(col1D, 2), opacityFill))
  ...
  legend(x = "topleft", box.lwd = 0, lty = c(1, 1), col = c(col1D, colFin), legend = c("Vaccination en cours", "Vaccination complète"), lwd = lwdLines)
