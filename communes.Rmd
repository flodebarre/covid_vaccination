...
x3 <- 35161
d3 <- dat[which(dat$med14_2018 == x3), ]
...
# Intermediate
dat3 <- dat[dat$med14_2018>35000 & dat$med14_2018 < 36000,]
x3 <- unique(dat3$med14_2018)
...
legend(x = 1.05*max(tmp$med14_2018), y = 0.5, 
...
```{r, eval = FALSE}
plot_ly(dat.all, x = ~med14_2014, y = ~med14_2018, text = ~paste(commune_residence, libelle_commune.x))
```
