...
pour 2021-10-09, et pour les autres sur 
https://github.com/rozierguillaume/covid-19, data/france/donnees-vacsi-a-fra.csv
", side = 1, line = 4.25, col = gray(0.6), cex = 0.5, font = 1, family = "mono", adj = 0)
}
